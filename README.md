# Homework 1 - *APP RAILS*

*App Rails* Trang web cho phép người dùng chia sẻ và cập nhật trạng thái. Due Date: 24:00 11/10/2016

Danh sách sinh viên: **1312421_Nguyễn Hoàng Phát - 1312305_Nguyễn Tuấn Kiệt**

URL: **https://hidden-savannah-92762.herokuapp.com/**
...
* [x] Đăng ký 1 tài khoản người dùng.
* [x] Valid tài khoản đăng ký, email đúng định dạng. 
* [x] Nhớ đăng nhập của user(cookie).
* [x] Change profile.
* [x] Đánh số trang.
...
<<<<<<< HEAD
![Video Walkthrough](signup.gif)
![Video Walkthrough](createmyaccount.gif)
=======
![Video Walkthrough](demo.gif)
>>>>>>> b8d6efc3892f1012204e06346f279c76a9ace197
